  ...
  return (
    <div className='promo-codes add flex-col'>
        ...
        <div className="list-table">
            <div className="list-table-format-promocodes promo-codes-table-format title">
                <b>Promo Code</b>
                <b>Discount</b>
                <b>Action</b>
            </div>
            ...
            {list.map((item, index) => (
                <div key={index} className="list-table-format-promocodes promo-codes-table-format content">
                    <p>{item.codeId}</p>
                    <p>{item.discount}%</p>
            ...
            {addPromoCode
            ? <div className="list-table-format-promocodes promo-codes-table-format add-promo-code-input">
            ...
            {!addPromoCode
            ? <div onClick={() => setAddPromoCode(true)} className="list-table-format-promocodes promo-codes-table-format add-promo-code">
